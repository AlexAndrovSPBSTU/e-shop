...
public class EmailSenderService {
    ...
    @Autowired
    public EmailSenderService(JavaMailSenderImpl mailSender, @Value("${emailUsername}") String username, @Value("${emailPassword}") String password, PurchaseRepository purchaseRepository, CustomerRepository customerRepository, CartItemRepository cartItemRepository) {
    ...
    public void sendEmail(int purchaseId, Principal principal) {
